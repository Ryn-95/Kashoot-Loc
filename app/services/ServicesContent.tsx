      ...
      <section className="px-6 lg:px-8 py-24 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]">
            ...
            <div className="md:col-span-2 group relative p-8 md:p-12 rounded-[2rem] bg-neutral-900 overflow-hidden hover:shadow-2xl hover:shadow-neutral-900/20 transition-all duration-500">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div>
                  <h3 className="text-3xl font-bold text-white mb-4">Livraison Express 2H</h3>
                  <p className="text-neutral-400 leading-relaxed text-lg max-w-md mb-6">
                    Paris & Île-de-France. Nous livrons vos <Link href="/categories/cameras" className="text-white hover:underline decoration-blue-500 underline-offset-4">caméras</Link>, <Link href="/categories/lumieres" className="text-white hover:underline decoration-blue-500 underline-offset-4">lumières</Link> et <Link href="/categories/drones" className="text-white hover:underline decoration-blue-500 underline-offset-4">drones</Link> directement sur le set.
                  </p>
            ...
            <div className="group p-8 md:p-10 rounded-[2rem] bg-neutral-50 border border-neutral-100 hover:border-blue-200 transition-all duration-500 hover:shadow-xl hover:shadow-blue-900/5">
              ...
              <h3 className="text-xl font-bold text-neutral-900 mb-3">Crew Certifié</h3>
            ...
            {/* Service 3: Assurance */}
            <div className="group p-8 md:p-10 rounded-[2rem] bg-neutral-50 border border-neutral-100 hover:border-purple-200 transition-all duration-500 hover:shadow-xl hover:shadow-purple-900/5">
              ...
              <h3 className="text-xl font-bold text-neutral-900 mb-3">Assurance Zen</h3>
            ...
            <div className="md:col-span-2 group relative p-8 md:p-12 rounded-[2rem] bg-white border border-neutral-200 overflow-hidden hover:border-neutral-300 transition-all duration-500 hover:shadow-2xl hover:shadow-neutral-200/50">
               ...
               <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
                 ...
                 <div className="flex-1">
                    <h3 className="text-2xl font-bold text-neutral-900 mb-3">Studio de Post-Production</h3>
            ...
            <Link href="/contact" className="group p-8 md:p-10 rounded-[2rem] bg-blue-600 flex flex-col justify-center items-center text-center cursor-pointer relative overflow-hidden">
               ...
               <div className="relative z-10">
                 <h3 className="text-2xl font-bold text-white mb-2">Un projet ?</h3>
